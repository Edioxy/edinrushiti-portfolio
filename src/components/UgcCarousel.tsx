...
import type { UgcItem } from "@/data/site";

type UgcCardProps = {
  item: UgcItem;
};

function UgcCard({ item }: UgcCardProps) {
  return (
        ...
        <div className="relative aspect-[9/16] overflow-hidden bg-[#0a0a0a]">
          {item.thumbnail ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-gradient-to-b from-[#161616] via-[#0a0a0a] to-black">
              ...
              <div className="relative flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-white/5 transition-all duration-500 group-hover:scale-110 group-hover:border-white/25">
